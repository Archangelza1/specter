...
_query = switch(_side) do {
	...
	case east: {_returnCount = 10; format["SELECT playerid, name, cash, bankacc, adminlevel, donatorlvl, bounty_licenses, bountylevel, bounty_gear, blacklist FROM players WHERE playerid='%1'",_uid];};
};
