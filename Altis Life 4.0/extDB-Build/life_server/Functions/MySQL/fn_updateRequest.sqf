...
switch (_side) do {
	...
	case east: {_query = format["UPDATE players SET name='%1', cash='%2', bankacc='%3', bounty_licenses='%4', bounty_gear='%6' WHERE playerid='%5'",_name,_cash,_bank,_licenses,_uid,_gear];};
};
